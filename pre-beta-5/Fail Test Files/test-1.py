...
class BrowserWindow(QMainWindow):
    ...
    def update_load_progress(self):
        ...
        current_web_view = self.sender()
        if current_web_view:
            tab_index = self.tab_widget.indexOf(current_web_view)
            self.tab_widget.setTabText(tab_index, f"Loading... {current_web_view.page().progress()}%")
